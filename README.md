...
|----------|-------------|------|
| <img src="https://github.com/IsaacBoku/IsaacBoku/blob/main/Gif_BiVolt.gif" alt="Puzzle Magnético" /> | Juego de puzzles con mecánicas de magnetismo. El jugador controla un robot con interacción física y eléctrica. | [Itch.io](https://isaacboku.itch.io/) |
| <img src="https://github.com/IsaacBoku/IsaacBoku/blob/main/PosterRockyRancherA2.png" alt="Rocky Rancher" width="300" /> | Juego de gestión y aventuras en granja, con mecánicas de exploración y recolección de recursos. | [Dimbersoft - Rocky Rancher](https://dimbersoft.itch.io/rocky-rancher) |
...
| <img src="https://github.com/IsaacBoku/IsaacBoku/blob/main/PosterTheColorOfTheLines.png" alt="Color of the Line" width="300" /> | Juego de puzzles basado en colores y líneas, con mecánicas creativas de resolución de acertijos. | [BumColor Studios - Color of the Line](https://bumcolorstudios.itch.io/color-of-the-line) |
